...
//                                    HttpServletResponse res,
//                                    FilterChain chain) throws ServletException, IOException {
//        // 1) 嘗試從 Cookie 取 Access Token
//        String accessToken = extractCookie(req.getCookies(), SecurityConfig.ACCESS_COOKIE);
//
//        // 2) 如果 Context 還沒有驗證資訊
...
//                String refreshToken = extractCookie(req.getCookies(), SecurityConfig.REFRESH_COOKIE);
//
...
//                    ResponseCookie newCookie = ResponseCookie.from(SecurityConfig.ACCESS_COOKIE, newAccess)
//                            .httpOnly(true).secure(false) // ⚠ 測試環境用 false，正式要 true
//                            .sameSite("Lax").path("/")
...
//    }
//
//    // ========== 小工具：把 Token 轉成 Authentication 丟進 SecurityContext ==========
