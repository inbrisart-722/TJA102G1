...
public interface CommentRepository extends JpaRepository<CommentVO, Integer>{
	...
	Integer findCountByExhibition(@Param("cs") String commentStatus, @Param("eid") Integer exhibitionId);
	...
	Integer findCountByParent(@Param("cs") String commentStatus, @Param("eid") Integer exhibitionId, @Param("pcid") Integer parentCommentId);
	...
	Slice<CommentVO> findComments(@Param("cs") String commentStatus, @Param("eid") Integer exhibitionId, @Param("cid") Integer commentId, Pageable pageable);
	...
	Slice<CommentVO> findCommentsByParent(@Param("cs") String commentStatus, @Param("eid") Integer exhibitionId, @Param("pcid") Integer parentCommentId, @Param("cid") Integer commentId, Pageable pageable);
